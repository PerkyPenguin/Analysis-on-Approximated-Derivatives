...
keypoint_method = 'contact_change_dyn'     # 'set_interval, or 'adaptive_jerk' or 'iterative_error' or 'contact_change' or 'contact_change_maxN', 'contact_change_dyn'
...
###################################
# Generate test data for different key-point methods
###################################
